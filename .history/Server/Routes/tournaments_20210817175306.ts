...
router.get('/:id/:match/:firstplayer/:secondplayer',AuthGuard, (req, res, next) => {
   ...
   *****************/
   ...
   tournament.findById(id, {}, {}, (err, tournamentItemToEdit) => 
   {
       ...
       {
        //Renders the edit a bracket page
       res.render('tournaments/bracketsEditOne', { title: 'Bracketfortournament', page: 'bracketsEditOne', tournaments: tournamentItemToEdit, displayName: UserDisplayName(req),playerOne:req.params.firstplayer,playerTwo:req.params.secondplayer});
       }
