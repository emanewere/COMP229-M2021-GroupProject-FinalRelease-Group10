...
router.get('/add',AuthGuard,(req, res, next) => {
...
router.get('/:id/:match/:firstplayer/:secondplayer',AuthGuard, (req, res, next) => {
   ...
   *****************/
   ...
   tournament.findById(id, {}, {}, (err, tournamentItemToEdit) => 
   {
       ...
       res.render('tournaments/bracketsEditTwo', {id:id, title: 'Bracketfortournament', page: 'bracketsEditTwo', tournaments: tournamentItemToEdit, displayName: UserDisplayName(req),userName: UserName(req)});
       }
       else
       {
        //Renders the edit a bracket page
       res.render('tournaments/bracketsEditOne', { id:id,title: 'Bracketfortournament', page: 'bracketsEditOne', tournaments: tournamentItemToEdit, displayName: UserDisplayName(req),playerOne:req.params.firstplayer,playerTwo:req.params.secondplayer});
       }
   ...
   *****************/
   ...
   tournament.findById(id, {}, {}, (err, tournamentItemToEdit) => 
   {
       if(err)
       {
        ...
        res.render('tournaments/activate', {id:id, title: 'Activatetournament', page: 'activate', tournaments: tournamentItemToEdit, displayName: UserDisplayName(req)});  
